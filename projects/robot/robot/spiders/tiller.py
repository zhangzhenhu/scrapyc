...
class RobotSpider(base.RobotSpider):
    ...
    def start_requests(self):
        ...
        yield scrapy.Request("http://www.marinejournal.cn/hyyhz/ch/reader/issue_browser.aspx",
        ...
        yield scrapy.Request("http://hnxbw.cnjournals.net/hznydxsk/ch/reader/issue_browser.aspx",
                             callback=self.parse_index)
        ...
        yield scrapy.Request("http://jsuese.scu.edu.cn/jsuese_cn/ch/reader/issue_browser.aspx",
                             callback=self.parse_index)
        ...
        yield scrapy.Request("http://pedologica.issas.ac.cn/trxb/ch/reader/issue_browser.aspx",
                             callback=self.parse_index)
        ...
        yield scrapy.Request("http://science.ijournals.cn/jsunature_cn/ch/reader/issue_browser.aspx",
                             callback=self.parse_index)
        ...
        yield scrapy.Request("http://www.biother.org/zgzlswzlzz/ch/reader/issue_browser.aspx",
                             callback=self.parse_index)
        yield scrapy.Request("http://www.bxyjg.com/ch/reader/issue_browser.aspx", callback=self.parse_index)
        yield scrapy.Request("http://www.chinaminingmagazine.com/ch/reader/issue_browser.aspx",
                             callback=self.parse_index)
        ...
        yield scrapy.Request("http://www.cspine.org.cn/zgjzjszz/ch/reader/issue_browser.aspx",
                             callback=self.parse_index)
        yield scrapy.Request("http://www.dqkxqk.ac.cn/dqkx/dqkx/ch/reader/issue_browser.aspx",
                             callback=self.parse_index)
        ...
        yield scrapy.Request("http://www.tjzhongyiyao.com/tjzyy/ch/reader/issue_browser.aspx",
                             callback=self.parse_index)
        ...
        yield scrapy.Request("http://zgbjyx.alljournal.net.cn/zgbjyxzz/ch/reader/issue_browser.aspx",
                             callback=self.parse_index)
