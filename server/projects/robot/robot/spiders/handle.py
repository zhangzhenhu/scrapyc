...
class HandleSpider(base.RobotSpider):
    ...
    def start_requests(self):
        ...
        yield scrapy.Request("http://ir.lib.ncu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://nchuir.lib.nchu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://hermes-ir.lib.hit-u.ac.jp/rs/browse-date",callback=self.parse)
        # yield scrapy.Request("")

        yield scrapy.Request("http://chur.chu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.cnu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.lib.cyut.edu.tw:8080/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.lib.isu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.lib.ksu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.lib.kuas.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.lib.ncku.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.lib.nknu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.lib.nthu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.lib.ntnu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.lib.pccu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.lib.pccu.edu.tw/ir/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.nctu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.ndhu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.niu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.nou.edu.tw/dspace/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.nuk.edu.tw:8080/ir/browse-date",callback=self.parse)
        yield scrapy.Request("http://irs.lib.ksu.edu.tw/NKNUIR/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.taitheo.org.tw:8080/ir/browse-date",callback=self.parse)
        yield scrapy.Request("http://ir.tajen.edu.tw:8080/browse-date",callback=self.parse)
        yield scrapy.Request("http://libir.tmu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://nccuir.lib.nccu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://nccur.lib.nccu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://nchuir.lib.nchu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://nhuir.nhu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://nthur.lib.nthu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://ntuer.lib.ntue.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://ntur.lib.ntu.edu.tw/browse-date",callback=self.parse)
        yield scrapy.Request("http://nutnr.lib.nutn.edu.tw/browse-date",callback=self.parse)
