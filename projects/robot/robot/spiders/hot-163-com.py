...
class RobotSpider(base.RobotSpider):
    ...
    def start_requests(self):
        yield scrapy.Request("http://hot.163.com/group/list/100/week/grownup/ranking?offset=0",
                             callback=self.parse_rank)
        yield scrapy.Request("http://hot.163.com/group/list/channel/2/100/week/grownup/ranking?offset=0",
                             callback=self.parse_rank)
        yield scrapy.Request("http://hot.163.com/group/list/channel/3/100/week/grownup/ranking?offset=0",
                             callback=self.parse_rank)
        yield scrapy.Request("http://hot.163.com/group/list/channel/4/100/week/grownup/ranking?offset=0",
                             callback=self.parse_rank)
        yield scrapy.Request("http://hot.163.com/group/list/channel/5/100/week/grownup/ranking?offset=0",
                             callback=self.parse_rank)
        yield scrapy.Request("http://hot.163.com/group/list/channel/6/100/week/grownup/ranking?offset=0",
                             callback=self.parse_rank)
